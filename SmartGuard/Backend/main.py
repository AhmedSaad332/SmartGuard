...
# Ensure backend package root is on sys.path so local packages (routers, services)
# import correctly regardless of how uvicorn/python is invoked.
...
async def startup_event():
    ...
    def run_stream():
        try:
            print("Starting RTSP stream processor automatically...")
            stream_processor.process_video_stream(
                video_source="rtsp://admin:CJNAKZ@192.168.1.5:554/h264/ch1/main/av_stream",  # RTSP camera
                video_id="rtsp_cam1",  # RTSP camera ID
